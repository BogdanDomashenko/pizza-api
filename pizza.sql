...
-- Mon 08 Aug 2022 08:59:13 PM EEST
...
-- -----------------------------------------------------
-- Table `PIZZA`.`orderShippings`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PIZZA`.`orderShippings` (
  `id` INT NOT NULL,
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_orderShipping_1_idx` (`userOrderID` ASC) VISIBLE,
  CONSTRAINT `fk_orderShipping_1`
...
-- -----------------------------------------------------
-- Table `PIZZA`.`callBacks`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PIZZA`.`callBacks` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `userID` INT NULL,
  `createdAt` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedAt` TIMESTAMP NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_callBack_1_idx` (`userID` ASC) VISIBLE,
  CONSTRAINT `fk_callBack_1`
    FOREIGN KEY (`userID`)
    REFERENCES `PIZZA`.`users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
...
-- -----------------------------------------------------
-- Table `PIZZA`.`deliveries`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PIZZA`.`deliveries` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `price` INT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
